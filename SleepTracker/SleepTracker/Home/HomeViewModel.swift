...
class HomeViewModel: ObservableObject {
    ...
    let daysOfWeek: [(id: String, initial: String)] = [("Mon", "M"), ("Tue", "T"), ("Wed", "W"), ("Thu", "T"), ("Fri", "F"), ("Sat", "S"), ("Sun", "S")]
    ...
    private func generateSampleData() {
        sleepData = [
            ...
            SleepData(date: Date().addingTimeInterval(-86400 * 1), sleepDuration: 7.2),
